...
void Mattress::registerModel(CommonRigidBodyBase* base)
{
	//load our obj mesh
	const char* fileName = "Mattress.obj";  //sphere8.obj";//sponza_closed.obj";//sphere8.obj";
	...
	//	  btScalar mass(0.);
	//	  auto bowl = base->createRigidBody(mass,bowlTransform,shape, btVector4(0,0,1,1));
