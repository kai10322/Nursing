...
struct Nursing : public CommonRigidBodyBase
{
...
void Nursing::renderScene()
{
	m_dynamicsWorld->getDebugDrawer()->setDebugMode(btIDebugDraw::DBG_DrawWireframe + btIDebugDraw::DBG_DrawContactPoints + btIDebugDraw::DBG_DrawAabb + btIDebugDraw::DBG_DrawNormals);
	CommonRigidBodyBase::renderScene();
}

CommonExampleInterface* NursingCreateFunc(CommonExampleOptions& options)
{
